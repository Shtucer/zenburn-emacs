...
;;;;; basic coloring
   ...
   `(link ((t (:foreground ,zenburn-yellow :underline t :weight ,z-maybe-bold))))
   ...
   `(success ((t (:foreground ,zenburn-green :weight ,z-maybe-bold))))
   `(warning ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
...
;;;;; compilation
   ...
   `(compilation-error-face ((t (:foreground ,zenburn-red-1 :weight ,z-maybe-bold :underline t))))
   ...
   `(compilation-warning-face ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold :underline t))))
   `(compilation-mode-line-exit ((t (:foreground ,zenburn-green+2 :weight ,z-maybe-bold))))
   `(compilation-mode-line-fail ((t (:foreground ,zenburn-red :weight ,z-maybe-bold))))
   `(compilation-mode-line-run ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
;;;;; completions
   `(completions-annotations ((t (:foreground ,zenburn-fg-1))))
;;;;; grep
   `(grep-context-face ((t (:foreground ,zenburn-fg))))
   `(grep-error-face ((t (:foreground ,zenburn-red-1 :weight ,z-maybe-bold :underline t))))
   `(grep-hit-face ((t (:foreground ,zenburn-blue))))
   `(grep-match-face ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
   `(match ((t (:background ,zenburn-bg-1 :foreground ,zenburn-orange :weight ,z-maybe-bold))))
;;;;; isearch
   `(isearch ((t (:foreground ,zenburn-yellow-2 :weight ,z-maybe-bold :background ,zenburn-bg+2))))
   `(isearch-fail ((t (:foreground ,zenburn-fg :background ,zenburn-red-4))))
   `(lazy-highlight ((t (:foreground ,zenburn-yellow-2 :weight ,z-maybe-bold :background ,zenburn-bg-05))))
   ...
   `(mode-line
     ((,class (:foreground ,zenburn-green+1
                           ...
                           :box (:line-width -1 :style released-button)))
      (t :inverse-video t)))
   `(mode-line-buffer-id ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(mode-line-inactive
...
;;;;; font lock
   `(font-lock-builtin-face ((t (:foreground ,zenburn-fg :weight ,z-maybe-bold))))
   ...
   `(font-lock-keyword-face ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(font-lock-negation-char-face ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(font-lock-preprocessor-face ((t (:foreground ,zenburn-blue+1))))
   `(font-lock-regexp-grouping-construct ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(font-lock-regexp-grouping-backslash ((t (:foreground ,zenburn-green :weight ,z-maybe-bold))))
   ...
   `(font-lock-warning-face ((t (:foreground ,zenburn-yellow-2 :weight ,z-maybe-bold))))
...
;;;;; newsticker
   ...
   `(newsticker-treeview-new-face ((t (:foreground ,zenburn-blue :weight ,z-maybe-bold))))
...
;;;;; android mode
   ...
   `(android-mode-error-face ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
...
;;;;; anzu
   `(anzu-mode-line ((t (:foreground ,zenburn-cyan :weight ,z-maybe-bold))))
;;;;; auctex
   `(font-latex-bold-face ((t (:inherit bold))))
   `(font-latex-warning-face ((t (:foreground nil :inherit font-lock-warning-face))))
   `(font-latex-sectioning-5-face ((t (:foreground ,zenburn-red :weight ,z-maybe-bold ))))
...
;;;;; circe
   ...
   `(circe-topic-diff-removed-face ((t (:foreground ,zenburn-red :weight ,z-maybe-bold))))
...
;;;;; ediff
   ...
   `(ediff-fine-diff-A ((t (:foreground ,zenburn-fg :background ,zenburn-red-2 :weight ,z-maybe-bold))))
   `(ediff-fine-diff-Ancestor ((t (:foreground ,zenburn-fg :background ,zenburn-red-2 weight bold))))
   `(ediff-fine-diff-B ((t (:foreground ,zenburn-fg :background ,zenburn-green :weight ,z-maybe-bold))))
   `(ediff-fine-diff-C ((t (:foreground ,zenburn-fg :background ,zenburn-blue-3 :weight ,z-maybe-bold ))))
...
;;;;; emacs-w3m
   ...
   `(w3m-header-line-location-title ((t (:foreground ,zenburn-yellow
                                                     :underline t :weight ,z-maybe-bold))))
...
;;;;; erc
   ...
   `(erc-bold-face ((t (:weight ,z-maybe-bold))))
   `(erc-current-nick-face ((t (:foreground ,zenburn-blue :weight ,z-maybe-bold))))
   ...
   `(erc-keyword-face ((t (:foreground ,zenburn-blue :weight ,z-maybe-bold))))
   `(erc-nick-default-face ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(erc-my-nick-face ((t (:foreground ,zenburn-red :weight ,z-maybe-bold))))
   `(erc-nick-msg-face ((t (:inherit erc-default))))
   `(erc-notice-face ((t (:foreground ,zenburn-green))))
   `(erc-pal-face ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
   `(erc-prompt-face ((t (:foreground ,zenburn-orange :background ,zenburn-bg :weight ,z-maybe-bold))))
...
;;;;; eshell
   `(eshell-prompt ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(eshell-ls-archive ((t (:foreground ,zenburn-red-1 :weight ,z-maybe-bold))))
   `(eshell-ls-backup ((t (:inherit font-lock-comment-face))))
   `(eshell-ls-clutter ((t (:inherit font-lock-comment-face))))
   `(eshell-ls-directory ((t (:foreground ,zenburn-blue+1 :weight ,z-maybe-bold))))
   `(eshell-ls-executable ((t (:foreground ,zenburn-red+1 :weight ,z-maybe-bold))))
   `(eshell-ls-unreadable ((t (:foreground ,zenburn-fg))))
   `(eshell-ls-missing ((t (:inherit font-lock-warning-face))))
   `(eshell-ls-product ((t (:inherit font-lock-doc-face))))
   `(eshell-ls-special ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(eshell-ls-symlink ((t (:foreground ,zenburn-cyan :weight ,z-maybe-bold))))
;;;;; flx
   `(flx-highlight-face ((t (:foreground ,zenburn-green+2 :weight ,z-maybe-bold))))
;;;;; flycheck
   `(flycheck-error
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,zenburn-red-1) :inherit unspecified))
      (t (:foreground ,zenburn-red-1 :weight ,z-maybe-bold :underline t))))
   `(flycheck-warning
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,zenburn-yellow) :inherit unspecified))
      (t (:foreground ,zenburn-yellow :weight ,z-maybe-bold :underline t))))
   `(flycheck-info
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,zenburn-cyan) :inherit unspecified))
      (t (:foreground ,zenburn-cyan :weight ,z-maybe-bold :underline t))))
   `(flycheck-fringe-error ((t (:foreground ,zenburn-red-1 :weight ,z-maybe-bold))))
   `(flycheck-fringe-warning ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(flycheck-fringe-info ((t (:foreground ,zenburn-cyan :weight ,z-maybe-bold))))
;;;;; flymake
   `(flymake-errline
     ((((supports :underline (:style wave)))
   ...
   `(flymake-warnline
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,zenburn-orange)
                   :inherit unspecified :foreground unspecified :background unspecified))
      (t (:foreground ,zenburn-orange :weight ,z-maybe-bold :underline t))))
   `(flymake-infoline
     ((((supports :underline (:style wave)))
       (:underline (:style wave :color ,zenburn-green)
                   :inherit unspecified :foreground unspecified :background unspecified))
      (t (:foreground ,zenburn-green-1 :weight ,z-maybe-bold :underline t))))
;;;;; flyspell
   `(flyspell-duplicate
     ((((supports :underline (:style wave)))
...
;;;;; full-ack
   ...
   `(ack-match ((t (:foreground ,zenburn-orange :background ,zenburn-bg-1 :weight ,z-maybe-bold))))
;;;;; git-commit
   `(git-commit-comment-action  ((,class (:foreground ,zenburn-green+1 :weight ,z-maybe-bold))))
   `(git-commit-comment-branch  ((,class (:foreground ,zenburn-blue+1  :weight ,z-maybe-bold))))
   `(git-commit-comment-heading ((,class (:foreground ,zenburn-yellow  :weight ,z-maybe-bold))))
;;;;; git-gutter
   `(git-gutter:added ((t (:foreground ,zenburn-green :weight ,z-maybe-bold :inverse-video t))))
   `(git-gutter:deleted ((t (:foreground ,zenburn-red :weight ,z-maybe-bold :inverse-video t))))
   `(git-gutter:modified ((t (:foreground ,zenburn-magenta :weight ,z-maybe-bold :inverse-video t))))
   `(git-gutter:unchanged ((t (:foreground ,zenburn-fg :weight ,z-maybe-bold :inverse-video t))))
;;;;; git-gutter-fr
   `(git-gutter-fr:added ((t (:foreground ,zenburn-green  :weight ,z-maybe-bold))))
   `(git-gutter-fr:deleted ((t (:foreground ,zenburn-red :weight ,z-maybe-bold))))
   `(git-gutter-fr:modified ((t (:foreground ,zenburn-magenta :weight ,z-maybe-bold))))
;;;;; git-rebase
...
;;;;; gnus
   ...
   `(gnus-summary-high-read ((t (:foreground ,zenburn-green :weight ,z-maybe-bold))))
   `(gnus-summary-high-ticked ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
   `(gnus-summary-high-unread ((t (:foreground ,zenburn-fg :weight ,z-maybe-bold))))
   `(gnus-summary-low-ancient ((t (:foreground ,zenburn-blue))))
   `(gnus-summary-low-read ((t (:foreground ,zenburn-green))))
   `(gnus-summary-low-ticked ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
   ...
   `(gnus-summary-normal-ticked ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
   `(gnus-summary-normal-unread ((t (:foreground ,zenburn-fg))))
   `(gnus-summary-selected ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
...
;;;;; helm
   ...
   `(helm-ff-directory ((t (:foreground ,zenburn-cyan :background ,zenburn-bg :weight ,z-maybe-bold))))
   ...
   `(helm-ff-invalid-symlink ((t (:foreground ,zenburn-red :background ,zenburn-bg :weight ,z-maybe-bold))))
   `(helm-ff-symlink ((t (:foreground ,zenburn-yellow :background ,zenburn-bg :weight ,z-maybe-bold))))
...
;;;;; helm-swoop
   ...
   `(helm-swoop-target-word-face ((t (:foreground ,zenburn-yellow :background ,zenburn-bg+2 :weight ,z-maybe-bold))))
;;;;; hl-line-mode
   `(hl-line-face ((,class (:background ,zenburn-bg-05))
                   (t :weight ,z-maybe-bold)))
...
;;;;; iedit-mode
   `(iedit-occurrence ((t (:background ,zenburn-bg+2 :weight ,z-maybe-bold))))
;;;;; jabber-mode
   ...
   `(jabber-title-small ((t (:height 1.1 :weight ,z-maybe-bold))))
   `(jabber-title-medium ((t (:height 1.2 :weight ,z-maybe-bold))))
   `(jabber-title-large ((t (:height 1.3 :weight ,z-maybe-bold))))
;;;;; js2-mode
   `(js2-warning ((t (:underline ,zenburn-orange))))
   `(js2-error ((t (:foreground ,zenburn-red :weight ,z-maybe-bold))))
...
;;;;; ledger-mode
   `(ledger-font-payee-uncleared-face ((t (:foreground ,zenburn-red-1 :weight ,z-maybe-bold))))
   ...
   `(ledger-font-reconciler-uncleared-face ((t (:foreground ,zenburn-red-1 :weight ,z-maybe-bold))))
...
;;;;;; headings and diffs
   ...
   `(magit-section-heading             ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(magit-section-heading-selection   ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
   `(magit-diff-file-heading           ((t (:weight ,z-maybe-bold))))
   `(magit-diff-file-heading-highlight ((t (:background ,zenburn-bg+05  :weight ,z-maybe-bold))))
   `(magit-diff-file-heading-selection ((t (:background ,zenburn-bg+05
                                            :foreground ,zenburn-orange :weight ,z-maybe-bold))))
...
;;;;;; popup
   `(magit-popup-heading             ((t (:foreground ,zenburn-yellow  :weight ,z-maybe-bold))))
   `(magit-popup-key                 ((t (:foreground ,zenburn-green-1 :weight ,z-maybe-bold))))
   `(magit-popup-argument            ((t (:foreground ,zenburn-green   :weight ,z-maybe-bold))))
   `(magit-popup-disabled-argument   ((t (:foreground ,zenburn-fg-1    :weight normal))))
   `(magit-popup-option-value        ((t (:foreground ,zenburn-blue-2  :weight ,z-maybe-bold))))
;;;;;; process
   `(magit-process-ok    ((t (:foreground ,zenburn-green  :weight ,z-maybe-bold))))
   `(magit-process-ng    ((t (:foreground ,zenburn-red    :weight ,z-maybe-bold))))
;;;;;; log
...
;;;;;; references etc
   ...
   `(magit-tag            ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
   `(magit-branch-remote  ((t (:foreground ,zenburn-green  :weight ,z-maybe-bold))))
   `(magit-branch-local   ((t (:foreground ,zenburn-blue   :weight ,z-maybe-bold))))
   `(magit-branch-current ((t (:foreground ,zenburn-blue   :weight ,z-maybe-bold :box t))))
   `(magit-head           ((t (:foreground ,zenburn-blue   :weight ,z-maybe-bold))))
   `(magit-refname        ((t (:background ,zenburn-bg+2 :foreground ,zenburn-fg :weight ,z-maybe-bold))))
   `(magit-refname-stash  ((t (:background ,zenburn-bg+2 :foreground ,zenburn-fg :weight ,z-maybe-bold))))
   `(magit-refname-wip    ((t (:background ,zenburn-bg+2 :foreground ,zenburn-fg :weight ,z-maybe-bold))))
...
;;;;; message-mode
   ...
   `(message-header-to ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(message-header-from ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(message-header-cc ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(message-header-newsgroups ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(message-header-subject ((t (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
   `(message-header-xheader ((t (:foreground ,zenburn-green))))
   `(message-mml ((t (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
...
;;;;; mew
   ...
   `(mew-face-header-marginal ((t (:foreground ,zenburn-fg :weight ,z-maybe-bold))))
...
;;;;; mic-paren
   `(paren-face-match ((t (:foreground ,zenburn-cyan :background ,zenburn-bg :weight ,z-maybe-bold))))
   `(paren-face-mismatch ((t (:foreground ,zenburn-bg :background ,zenburn-magenta :weight ,z-maybe-bold))))
   `(paren-face-no-match ((t (:foreground ,zenburn-bg :background ,zenburn-red :weight ,z-maybe-bold))))
;;;;; mingus
...
;;;;; org-mode
   `(org-agenda-date-today
     ((t (:foreground ,zenburn-fg+1 :slant italic :weight ,z-maybe-bold))) t)
   `(org-agenda-structure
     ((t (:inherit font-lock-comment-face))))
   `(org-archived ((t (:foreground ,zenburn-fg :weight ,z-maybe-bold))))
   ...
   `(org-done ((t (:bold t :weight ,z-maybe-bold :foreground ,zenburn-green+3))))
   ...
   `(org-tag ((t (:bold t :weight ,z-maybe-bold))))
   `(org-time-grid ((t (:foreground ,zenburn-orange))))
   `(org-todo ((t (:bold t :foreground ,zenburn-red :weight ,z-maybe-bold))))
   `(org-upcoming-deadline ((t (:inherit font-lock-keyword-face))))
   `(org-warning ((t (:bold t :foreground ,zenburn-red :weight ,z-maybe-bold :underline nil))))
   `(org-column ((t (:background ,zenburn-bg-1))))
   `(org-column-title ((t (:background ,zenburn-bg-1 :underline t :weight ,z-maybe-bold))))
...
;;;;; show-paren
   `(show-paren-mismatch ((t (:foreground ,zenburn-red+1 :background ,zenburn-bg+3 :weight ,z-maybe-bold))))
   `(show-paren-match ((t (:background ,zenburn-bg+3 :weight ,z-maybe-bold))))
;;;;; smart-mode-line
   ;; use (setq sml/theme nil) to enable Zenburn for sml
   `(sml/global ((,class (:foreground ,zenburn-fg :weight ,z-maybe-bold))))
   `(sml/modes ((,class (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(sml/minor-modes ((,class (:foreground ,zenburn-fg-1 :weight ,z-maybe-bold))))
   `(sml/filename ((,class (:foreground ,zenburn-yellow :weight ,z-maybe-bold))))
   `(sml/line-number ((,class (:foreground ,zenburn-blue :weight ,z-maybe-bold))))
   `(sml/col-number ((,class (:foreground ,zenburn-blue+1 :weight ,z-maybe-bold))))
   `(sml/position-percentage ((,class (:foreground ,zenburn-blue-1 :weight ,z-maybe-bold))))
   `(sml/prefix ((,class (:foreground ,zenburn-orange))))
   `(sml/git ((,class (:foreground ,zenburn-green+3))))
   `(sml/process ((,class (:weight ,z-maybe-bold))))
   `(sml/sudo ((,class  (:foreground ,zenburn-orange :weight ,z-maybe-bold))))
...
;;;;; smartparens
   `(sp-show-pair-mismatch-face ((t (:foreground ,zenburn-red+1 :background ,zenburn-bg+3 :weight ,z-maybe-bold))))
   `(sp-show-pair-match-face ((t (:background ,zenburn-bg+3 :weight ,z-maybe-bold))))
;;;;; sml-mode-line
...
;;;;; undo-tree
   `(undo-tree-visualizer-active-branch-face ((t (:foreground ,zenburn-fg+1 :weight ,z-maybe-bold))))
   `(undo-tree-visualizer-current-face ((t (:foreground ,zenburn-red-1 :weight ,z-maybe-bold))))
...
;;;;; web-mode
   ...
   `(web-mode-css-pseudo-class-face ((t (:foreground ,zenburn-green+3 :weight ,z-maybe-bold))))
...
;;;;; wanderlust
   ...
   `(wl-highlight-summary-displaying-face ((t (:underline t :weight ,z-maybe-bold))))
;;;;; which-func-mode
